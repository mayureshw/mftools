...
class PFViews(PFData):
    ...
    def pfgainreport(self):
        ...
        printTbl([[ 'EQ' if o.iseq else 'DT', o.isfree, po.shortf(), o.units, o.cost(), o.value(),
            o.value()-o.cost(), ((o.value()-o.cost())*100/o.cost()) if o.cost() else '-', o.cagr(),
            str(po.rating()), po.oyret(), po.subcat() ]
            for o,po in self.buymatches()],
            title = 'PFGAIN',
            colnames = ['Typ','Free','Fund','Units','Cost','Value','Gain','%Gain','CAGR','Rat','1YRet',
                'Subcat'],
            sort = [-1,-2,-9,10],
